...
<link rel="stylesheet" href="resc/css/podium2.css">

<link rel="stylesheet" href="resc/css/leaderboard.css">
    ...
    <table id="podium">
      <tr>
        <td>
          ...
          <div id="second" class="bg-warning">
        ...
        <td>
          <div class="text-center">
          <div class="dGrid ">
                    <i class="fas fa-crown m-auto bg-white rounded-circle p-2" style="color:#fd7e14;height:3rem;"></i>
                    <span>1</span>
                    </div>
                    </div>
          <div id="first" class="bg-success">
          <div class="text-inside">
                        <span class="player">
                        Hakan
                        </span>
...
<article class="leaderboard ml-auto mr-auto">
  <header>
    ...
    <h1 class="leaderboard__title"><span class="leaderboard__title--top">Ayın</span><span class="leaderboard__title--bottom">Üreticileri</span></h1>
  </header>

  <main class="leaderboard__profiles">
    <article class="leaderboard__profile">
      <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Mark Zuckerberg" class="leaderboard__picture">
      <span class="leaderboard__name">Hasan Nuri</span>
      <span class="leaderboard__value">10.378<span>&#8378;</span></span>
    </article>

    <article class="leaderboard__profile">
      <img src="https://randomuser.me/api/portraits/men/97.jpg" alt="Dustin Moskovitz" class="leaderboard__picture">
      <span class="leaderboard__name">Mehmet Kara</span>
      <span class="leaderboard__value">8.693<span>&#8378;</span></span>
    </article>

    <article class="leaderboard__profile">
      <img src="https://randomuser.me/api/portraits/women/17.jpg" alt="Elizabeth Holmes" class="leaderboard__picture">
      <span class="leaderboard__name">Fatma Beyaz</span>
      <span class="leaderboard__value">3.914<span>&#8378;</span></span>
    </article>

    <article class="leaderboard__profile">
      <img src="https://randomuser.me/api/portraits/men/37.jpg" alt="Evan Spiegel" class="leaderboard__picture">
      <span class="leaderboard__name">Mehmet Fatih</span>
      <span class="leaderboard__value">1.252<span>&#8378;</span></span>
    </article>
  </main>
</div>
